...
<body class="min-h-screen flex flex-col">
    ...
    <header class="bg-white p-4 shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6 text-gray-600 font-medium items-center">
                ...
                <a href="about.php" class="hover:text-black transition-colors text-black font-semibold">About</a>
    ...
    <section class="flex-grow container mx-auto p-8">
        ...
        <div class="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8 mb-12">
            <!-- Image Section -->
            <div class="md:w-1/2 h-96 rounded-xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1160&q=80" 
                     alt="Velvet Vogue Team" class="w-full h-full object-cover">
            </div>
            
            <div class="md:w-1/2 p-6 bg-white rounded-xl shadow-md">
                <p class="text-gray-700 leading-relaxed mb-4">
                    Velvet Vogue is more than just a clothing store; we are a fashion destination for the modern individual. We believe that what you wear is a powerful form of self-expression. Our brand was born from a passion for style, quality, and individuality, and we are committed to helping you curate a wardrobe that truly reflects who you are.
                </p>
                <p class="text-gray-700 leading-relaxed mb-4">
                    Every piece in our collection is carefully selected to ensure it meets our high standards of design and durability. We partner with talented designers and ethical manufacturers to bring you a range of clothing that is not only fashionable but also made to last. Our mission is to make high-quality, expressive fashion accessible to everyone, empowering you to feel confident and stylish in any setting.
                </p>
                <p class="text-gray-700 leading-relaxed">
                    Join us on this journey as we redefine casual and formal wear. From our seasonal collections to our timeless staples, we invite you to explore the world of Velvet Vogue and discover the perfect pieces to elevate your personal style. Thank you for choosing us to be a part of your fashion story.
                </p>
            </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-xl shadow-md">
                ...
                <p class="text-gray-700">To inspire confidence and self-expression through thoughtfully designed, high-quality, and accessible fashion.</p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md">
                <h3 class="text-xl font-bold mb-2">Our Vision</h3>
                <p class="text-gray-700">To become the leading online destination for modern, trend-conscious individuals seeking unique and sustainable style solutions.</p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md">
                <h3 class="text-xl font-bold mb-2">Our Values</h3>
                <p class="text-gray-700">Quality, Integrity, Innovation, and Customer Satisfaction are at the heart of everything we do.</p>
            </div>
        </div>
    </section>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (navSearch) {
        navSearch.addEventListener('input', function() {
            ...
            // For about page, we'll redirect to collection for product search
            if (query.length >= 2) {
